        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-1.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 focus-visible:ring-2 focus-visible:ring-blue-400 rounded p-2 transition"
            >
